<template>
  <div>
    ...
    <form novalidate @submit.prevent="onSubmit(email, username,password)">
...
export default {
  ...
  methods: {
    onSubmit(email,username,password) {
      store.dispatch("register", { user: { email, username, password } }).then(() => this.$router.push({ name: "Profile" }));
    }
  },
  computed: {
